                ...
                if (isset($_GET['id'])) {
                    ...
                    if(isset($_GET['filtro'])){
                        if (count($final) != 0) { ?>
                            ...
                            ?>
                            <a href="listar_users.php?idUser=<?php echo $filtro["idUser"] ?>">
                                <div id="container">
                                        <div id="users">
                                            <img src="./assets/images/user.png" alt="">
                                            <span><?php echo $filtro["nombre"] ?></span>
                                        </div>
                                        <p style="display: none;"><?php echo $filtro["idUser"] ?></p>
                                        <p>Direccion: <?php echo $filtro["direccion"] ?> </p>
                                        <p>Correo: <?php echo $filtro["correo"] ?> </p>
                                        <?php
                                        if (isset($filtro["disponibilidad_inicio1"])) {
                                        ?>
                                            <p>Disponibilidad Inicio: <?php echo $filtro["disponibilidad_inicio1"] ?> </p>
                                        <?php
                                        }
                                        ?>
    
                                        <?php
                                        if (isset($filtro["disponibilidad_fin1"])) {
                                        ?>
                                            <p>Disponibilidad Fin: <?php echo $filtro["disponibilidad_fin1"] ?> </p>
                                        <?php
                                        }
                                        ?>
                                        <?php
                                        if (isset($filtro["disponibilidad_inicio2"])) {
                                        ?>
                                            <p>Disponibilidad Inicio2: <?php echo $filtro["disponibilidad_inicio2"] ?> </p>
                                        <?php
                                        }
                                        ?>
    
                                        <?php
                                        if (isset($filtro["disponibilidad_fin2"])) {
                                        ?>
    
                                            <p>Disponibilidad Fin: <?php echo $filtro["disponibilidad_fin2"] ?> </p>
                                        <?php
                                        }
                                        ?>
                                        <?php
                                        if (isset($filtro["disponibilidad_inicio3"])) {
                                        ?>
                                            <p>Disponibilidad Inicio3: <?php echo $filtro["disponibilidad_inicio3"] ?> </p>
                                        <?php
                                        }
                                        ?>
    
                                        <?php
                                        if (isset($filtro["disponibilidad_fin3"])) {
                                        ?>
                                            <p>Disponibilidad Fin: <?php echo $filtro["disponibilidad_fin3"] ?> </p>
                                        <?php
                                        }
                                        ?>
                                    </div>
