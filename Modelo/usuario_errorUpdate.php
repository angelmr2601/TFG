...
function crearUsuario($username, $correo, $contrasena, $direccion, $disponibilidad_inicio1, $disponibilidad_fin1)
{
    $sqlCrear = "INSERT INTO usuario(nombre,correo, contraseña, direccion, disponibilidad_inicio1 ,disponibilidad_fin1, activo)
    VALUES ('$username','$correo','$contrasena', '$direccion', '$disponibilidad_inicio1', '$disponibilidad_fin1','1')";
...
{
    $user = findOneByCorreoUser($correo)["nombre"];
    return $user;
}
...
function updateUsuario(
    ...
    $sqlUpdate = "UPDATE usuario SET ,nombre='$username',contraseña='$contrasena',direccion='$direccion',sobre_mi='$sobre_mi',disponibilidad_inicio1='$disponibilidad_inicio1',disponibilidad_fin1='$disponibilidad_fin1',disponibilidad_inicio2='$disponibilidad_inicio2',disponibilidad_fin2='$disponibilidad_fin2',disponibilidad_inicio3='$disponibilidad_inicio3',disponibilidad_fin3='$disponibilidad_fin3',instagram='$instagram',yt='$yt',spotify='$spotify',tiktok='$tiktok' WHERE idUser = '$idUser'";
